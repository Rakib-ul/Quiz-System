            ...
            <div class="w-full max-w-md bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
                <div class="px-8 py-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-2xl font-extrabold text-gray-900">Total Mcqs: {{ $totalMcqs }}</p>
                        @if ($totalMcqs>0)
                        <span><a href="show-quiz/{{session('quizDetails')['id']}}">Show MCQs</a></span>
                    ...
                    <form action="add-quiz" method="get" class="space-y-5">
                        ...
                        <div>
                            ...
                            <select id="category_id" name="category_id"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors shadow-sm outline-none bg-white"
                                required>
        ...
        @else
            <div class="w-full max-w-2xl bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 p-8">
                ...
                <div class="flex flex-col items-center mb-8">
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-green-100 text-green-800 border border-green-200 mb-4">
                ...
                <form action="add-mcq" method="post" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="question" name="question" rows="3" placeholder="Enter your question here..."
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors shadow-sm outline-none resize-none"></textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="option_a"
                                class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Option A</label>
                            <input type="text" id="option_a" name="a" placeholder="First option"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors shadow-sm outline-none">
                            @error('a')
                                <div class="text-red-500">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            <label for="option_b"
                                class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Option B</label>
                        ...
                        <div>
                            <label for="option_c"
                                class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Option C</label>
                        ...
                        <div>
                            <label for="option_d"
                                class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Option D</label>
                    ...
                    <div class="pt-2">
                        <label for="correct_ans" class="block text-sm font-semibold text-gray-700 mb-1">Correct
                            Answer</label>
                        <select id="correct_ans" name="correct_ans"
                            class="w-full md:w-1/2 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors shadow-sm outline-none bg-white font-medium">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-6 mt-4 border-t border-gray-100">
                        ...
                        <a href="/end-quiz" class="flex-1 flex justify-center items-center bg-red-600 text-white py-2.5 px-4 rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-200 transition duration-300 font-bold shadow-md">Finish and End</a>
