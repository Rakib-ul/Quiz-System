    ...
    <main class="flex-grow py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-5xl mx-auto w-full">
            ...
            <div class="mb-8 text-center sm:text-left">
                ...
                <p class="mt-2 text-sm text-gray-500">Search for a category and select a quiz to test your knowledge.
                </p>
            </div>
            ...
            <form action="search-quiz" method="get">
                <div class="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="relative w-full max-w-md">
                        <input name= "search" type="text" placeholder="Search categories or quizzes..."
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-200 rounded-2xl overflow-hidden">
                ...
                <div
                    class="px-6 py-5 border-b border-gray-100 bg-gray-50 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full whitespace-nowrap text-left text-sm text-gray-600">
                        ...
                        <thead
                            class="bg-white border-b border-gray-200 text-gray-500 uppercase text-xs font-semibold tracking-wider">
                            <tr>
