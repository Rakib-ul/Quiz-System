...
<body class="bg-gray-50 text-gray-900 font-sans antialiased min-h-screen flex flex-col">
    ...
    <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 flex-grow">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                <h3 class="text-2xl text-center font-bold text-gray-900 tracking-tight">Category Name: {{ $category }}
                </h3>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 text-left text-sm text-gray-600">
                    <thead class="bg-gray-50/75 border-b border-gray-200">
                        <tr>
                            <th scope="col"
                                class="px-6 py-4 font-semibold text-gray-500 uppercase tracking-wider text-xs">
                                Quiz ID
                            </th>
                            <th scope="col"
                                class="px-6 py-4 font-semibold text-gray-500 uppercase tracking-wider text-xs w-2/3">
                                Quiz Name
                            </th>
                            <th scope="col"
                                class="px-6 py-4 font-semibold text-gray-500 uppercase tracking-wider text-xs w-2/3">
                            ...
                            <th scope="col"
                                class="px-6 py-4 font-semibold text-gray-500 uppercase tracking-wider text-xs text-right">
                                Actions
                            </th>
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4 text-gray-900 font-medium">
                                    <a href="/start-quiz/{{$item->id}}/{{$item->name}}"
                                        class="text-green-700 font-bold">Attempt Quiz</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-16 text-center text-gray-500">
                                    ...
                                    <p class="text-sm mt-1 text-gray-500">There are currently no quizzes associated with
                                        this category.</p>
                                </td>
                            </tr>
                        @endforelse
...
@if(session('error'))
    <div id="errorBox" class="bg-red-100 text-red-700 p-3 rounded mb-4">
        {{ session('error') }}
    </div>
